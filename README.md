...
| 2 | API core: auth, entities, properties, snapshots, `/calculate`, portfolio, users, audit, tests, CI, Render artifacts | ✅ Complete on branch `plan-2-api-core` (40 commits, awaiting merge) |
